...
/*
Escala de plantao por unidade, data, dia da semana, turno, residente e preceptor.
O enunciado define dia_semana/turno; a data_plantao foi incluida para permitir
filtrar corretamente os plantoes do mes corrente nas consultas analiticas.
*/
CREATE TABLE escala (
    ...
    CONSTRAINT uq_escala_unidade_data_turno_residente UNIQUE (id_unidade, data_plantao, turno, id_residente)
);
...
CREATE INDEX idx_escala_data ON escala(data_plantao);